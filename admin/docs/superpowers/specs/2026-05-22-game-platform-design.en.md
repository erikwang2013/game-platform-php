...
- Database: MySQL 8.0+, table prefix `game_`
...
| # | Table | Description |
|------|------|------|
| 1 | `game_user` | C-end users |
| 2 | `game_user_wallet` | Platform currency wallet |
| 3 | `game_user_game_wallet` | Game currency wallet |
| 4 | `game_game` | Games |
| 5 | `game_game_currency` | Game currencies |
| 6 | `game_deposit_order` | Deposit orders |
| 7 | `game_withdraw_order` | Withdrawal orders |
| 8 | `game_exchange_record` | Exchange records |
| 9 | `game_transaction` | Platform transactions |
| 10 | `game_payment_method` | Payment methods |
| 11 | `game_announcement` | Announcements |
| 12 | `game-platform_config` | Platform config (extends existing game_system_config) |

### 5.2 Standard Version Additions (10 tables)

| # | Table | Description |
|------|------|------|
| 13 | `game_user_identity` | Real-name/KYC |
| 14 | `game_user_oauth` | Third-party login |
| 15 | `game_user_payment_account` | Payout accounts |
| 16 | `game_user_session` | Login sessions |
| 17 | `game_game_server` | Game servers |
| 18 | `game_game_play_log` | Game play records |
| 19 | `game_withdraw_limit` | Withdrawal limit rules |
| 20 | `game_risk_rule` | Risk control rules |
| 21 | `game_risk_log` | Risk trigger records |
| 22 | `game_stat_daily` | Daily statistics snapshot |

### 5.3 Complete Version Additions (8 tables)

| # | Table | Description |
|------|------|------|
| 23 | `game_game_category` | Game categories |
| 24 | `game_game_category_rel` | Game-category relations |
| 25 | `game_leaderboard` | Leaderboards |
| 26 | `game_coupon` | Coupons |
| 27 | `game_user_coupon` | User coupon claims |
| 28 | `game_language` | Language definitions |
| 29 | `game_translation` | Translation texts |
| 30 | `game_country_config` | Country config |
| 31 | `game-platform_revenue` | Platform revenue records |
