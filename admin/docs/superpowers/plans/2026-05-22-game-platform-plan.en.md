# Global Game Aggregation Platform Basic Version — Implementation Plan
<!-- lang-nav -->

Languages: [中文](2026-05-22-game-platform-plan.md) · **English** · [한국어](2026-05-22-game-platform-plan.ko.md) · [Русский](2026-05-22-game-platform-plan.ru.md) · [Deutsch](2026-05-22-game-platform-plan.de.md) · [Français](2026-05-22-game-platform-plan.fr.md) · [Español](2026-05-22-game-platform-plan.es.md) · [Português](2026-05-22-game-platform-plan.pt.md) · [हिन्दी](2026-05-22-game-platform-plan.hi.md) · [العربية](2026-05-22-game-platform-plan.ar.md) · [বাংলা](2026-05-22-game-platform-plan.bn.md) · [Bahasa Indonesia](2026-05-22-game-platform-plan.id.md) · [日本語](2026-05-22-game-platform-plan.ja.md)


> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Get the core loop working end-to-end: register → deposit → exchange → game currency → withdraw → admin review

**Architecture:** admin/ (admin backend) and service/ (C-side business) are independent webman v2 instances that share Models and Services through common/ (PSR-4 autoload). Database migrations live together in admin/database/migrations/. Frontend: extend the existing Flutter PC admin backend + create a new C-side PC platform.

**Tech Stack:** PHP 8.3+, webman v2, MySQL 8.0, Redis, erikwang2013/* components
