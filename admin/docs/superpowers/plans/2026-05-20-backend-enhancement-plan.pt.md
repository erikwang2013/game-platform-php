...
**Objetivo:** Implementar 13 aprimoramentos de backend: 3 novos middlewares (CORS, RateLimit, OperationLog), 6 novos controllers, 2 modificações de modelo, roteamento + configuração de middlewares.

**Arquitetura:** Seguir os padrões webman existentes — middlewares implementam `MiddlewareInterface::process()`, controllers herdam `BaseController`, rotas definidas com closures ou `[class, method]`. Middlewares globais são registrados em `config/middleware.php`, middlewares de rota são montados nos grupos de rotas em `config/route.php`.

**Stack de Tecnologias:** PHP 8.3+, webman v2, Redis (extensão), PhpSpreadsheet (importação)

**Ordem de Dependências:** Modificações de modelo → middlewares → controllers → rotas/config

---

### Task 1: Adicionar SoftDeletes + Searchable trait ao modelo AdminUser

**Arquivos:**
- Modificar: `app/model/AdminUser.php`

- [ ] **Step 1: Modificar o modelo AdminUser**

Insira duas importações `use` após a linha 10 de `app/model/AdminUser.php` e use os dois traits no início do corpo da classe:
...
Ao mesmo tempo, adicione o método `toSearchableArray()` no final da classe (após o método `roles()`, antes da chave de fechamento da classe):
...
**Arquivos:**
- Criar: `app/middleware/Cors.php`

- [ ] **Step 1: Criar o middleware Cors**
...
### Task 3: Middleware de limite de taxa RateLimit

**Arquivos:**
- Criar: `app/middleware/RateLimit.php`

- [ ] **Step 1: Criar o middleware RateLimit**
...
### Task 4: Middleware de log de operações OperationLog

**Arquivos:**
- Criar: `app/middleware/OperationLog.php`

- [ ] **Step 1: Criar o middleware OperationLog**
...
### Task 5: Configuração de middlewares globais

**Arquivos:**
- Modificar: `config/middleware.php`

- [ ] **Step 1: Registrar os middlewares globais**

Altere o conteúdo de `config/middleware.php` para:
...
### Task 6: Controller de verificação de saúde

**Arquivos:**
- Criar: `app/admin/controller/HealthController.php`

- [ ] **Step 1: Criar o HealthController**
...
### Task 7: Controller CRUD de configuração do sistema

**Arquivos:**
- Criar: `app/admin/controller/ConfigController.php`

- [ ] **Step 1: Criar o ConfigController**
...
### Task 8: Controller de consulta de logs de operação

**Arquivos:**
- Criar: `app/admin/controller/LogController.php`

- [ ] **Step 1: Criar o LogController**
...
### Task 9: Controller do perfil (com logout)

**Arquivos:**
- Criar: `app/admin/controller/ProfileController.php`
- Modificar: `app/middleware/AdminAuth.php` (validação de blacklist JWT)

- [ ] **Step 1: Modificar o middleware AdminAuth para adicionar a verificação de blacklist JWT**

No método `AdminAuth::process()`, insira a verificação de blacklist após a extração do token e antes da decodificação do JWT:
...
Também é necessário adicionar a importação do Redis. Modifique o cabeçalho do arquivo:
...
- [ ] **Step 2: Criar o ProfileController**
...
### Task 10: Controller de upload de arquivos

**Arquivos:**
- Criar: `app/admin/controller/UploadController.php`

- [ ] **Step 1: Criar o UploadController**
...
### Task 11: Operações em lote de usuários

**Arquivos:**
- Modificar: `app/admin/controller/UserController.php`

- [ ] **Step 1: Adicionar dois métodos ao final da classe UserController (após o método `destroy`)**
...
### Task 12: Controller de importação Excel

**Arquivos:**
- Criar: `app/admin/controller/ImportController.php`

- [ ] **Step 1: Criar o ImportController**
...
### Task 13: Atualização de rotas — todas as novas rotas + vínculo de middlewares

**Arquivos:**
- Modificar: `config/route.php`

- [ ] **Step 1: Atualizar a configuração de rotas**

Adicione as novas rotas dentro do grupo `/admin` e acrescente o middleware OperationLog. Arquivo de rotas completo:
...
Após a implementação, verifique item por item:
