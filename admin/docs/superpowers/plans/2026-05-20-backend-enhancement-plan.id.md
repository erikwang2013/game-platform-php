...
**Tech Stack:** PHP 8.3+, webman v2, Redis (ekstensi), PhpSpreadsheet (impor)

**Urutan dependensi:** Modifikasi model → middleware → controller → rute/konfigurasi

---

### Task 1: Model AdminUser + trait SoftDeletes dan Searchable

**Files:**
- Modify: `app/model/AdminUser.php`

- [ ] **Step 1: Modifikasi model AdminUser**

Sisipkan dua import `use` setelah baris 10 di `app/model/AdminUser.php`, dan gunakan kedua trait di awal tubuh kelas:
...
Tambahkan juga metode `toSearchableArray()` di akhir kelas (setelah metode `roles()`, sebelum kurung tutup kelas):
...
### Task 3: Middleware RateLimit

**Files:**
- Create: `app/middleware/RateLimit.php`

- [ ] **Step 1: Buat middleware RateLimit**
...
### Task 4: Middleware OperationLog (log operasi)

**Files:**
- Create: `app/middleware/OperationLog.php`

- [ ] **Step 1: Buat middleware OperationLog**
...
- [ ] **Step 1: Daftarkan middleware global**
...
### Task 8: Controller query log operasi

**Files:**
- Create: `app/admin/controller/LogController.php`

- [ ] **Step 1: Buat LogController**
...
### Task 9: Controller profil pribadi (termasuk logout)

**Files:**
- Create: `app/admin/controller/ProfileController.php`
- Modify: `app/middleware/AdminAuth.php` (verifikasi blacklist JWT)

- [ ] **Step 1: Modifikasi middleware AdminAuth, tambahkan verifikasi blacklist JWT**
...
Perlu menambahkan import Redis secara bersamaan. Modifikasi header file:
...
- [ ] **Step 1: Tambahkan dua metode di akhir kelas UserController (setelah metode `destroy`)**
...
- [ ] **Step 1: Perbarui konfigurasi rute**

Tambahkan rute baru di dalam grup rute `/admin`, sekaligus lampirkan middleware OperationLog. File rute lengkap:
