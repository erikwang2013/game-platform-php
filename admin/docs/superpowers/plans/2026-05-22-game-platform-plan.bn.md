...
Languages: [中文](2026-05-22-game-platform-plan.md) · [English](2026-05-22-game-platform-plan.en.md) · [한국어](2026-05-22-game-platform-plan.ko.md) · [Русский](2026-05-22-game-platform-plan.ru.md) · [Deutsch](2026-05-22-game-platform-plan.de.md) · [Français](2026-05-22-game-platform-plan.fr.md) · [Español](2026-05-22-game-platform-plan.es.md) · [Português](2026-05-22-game-platform-plan.pt.md) · [हिन्दी](2026-05-22-game-platform-plan.hi.md) · [العربية](2026-05-22-game-platform-plan.ar.md) · **বাংলা** · [Bahasa Indonesia](2026-05-22-game-platform-plan.id.md) · [日本語](2026-05-22-game-platform-plan.ja.md)


> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** মূল ক্লোজড-লুপ চালু করা: রেজিস্ট্রেশন → টপ-আপ → বিনিময় → গেম কয়েন → উত্তোলন → ব্যাকএন্ড অনুমোদন

**Architecture:** admin/ (প্রশাসনিক প্যানেল) এবং service/ (C-এন্ড ব্যবসা) দুটি স্বাধীন webman v2 ইনস্ট্যান্স; এরা common/ (PSR-4 autoload) এর মাধ্যমে Model ও Service শেয়ার করে। ডেটাবেস মাইগ্রেশন একীভূতভাবে admin/database/migrations/-এ রাখা হয়। ফ্রন্টএন্ড Flutter PC প্রশাসনিক প্যানেল এক্সটেনশন + নতুন C-এন্ড PC প্ল্যাটফর্ম।

**Tech Stack:** PHP 8.3+, webman v2, MySQL 8.0, Redis, erikwang2013/* সিরিজ কম্পোনেন্ট
...
- `common/model/` — Eloquent Model, ডেটা টেবিলের সাথে এক-এক সম্পর্ক, casts/relations সংজ্ঞায়িত করে
- `service/app/api/v1/controller/` — C-এন্ড API, ইউজার অনুরোধ প্রক্রিয়া করে, Model কল করে
- `admin/app/admin/controller/` — প্রশাসনিক প্যানেল API, অ্যাডমিন অপারেশন
- `common/middleware/UserAuth.php` — C-এন্ড JWT যাচাই মিডলওয়্যার, userId ইনজেক্ট করে

---

## Phase 1: 基础设施搭建

### Task 1: common/composer.json তৈরি ও নেমস্পেস সংজ্ঞায়িত করা
...
### Task 2: common/ কে admin-এ রেজিস্টার করা এবং service/ autoload কনফিগ তৈরি করা
...
`admin/composer.json`-এ, `"autoload"` → `"psr-4"` ব্লকে যোগ করুন:
...
### Task 3: service/ ডিরেক্টরি স্ট্রাকচার ও composer.json সেটআপ
...
### Task 4: service/ কনফিগ ফাইল তৈরি
...
`admin/config/` থেকে সব কনফিগ ফাইল `service/config/`-এ কপি করুন, মান সমন্বয় করে:
...
### Task 5: service/-এ শেয়ার্ড মিডলওয়্যার কপি ও UserAuth তৈরি
