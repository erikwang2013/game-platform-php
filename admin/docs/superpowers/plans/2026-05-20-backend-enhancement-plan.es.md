# Mejora del backend — Plan de implementación
<!-- lang-nav -->

Languages: [中文](2026-05-20-backend-enhancement-plan.md) · [English](2026-05-20-backend-enhancement-plan.en.md) · [한국어](2026-05-20-backend-enhancement-plan.ko.md) · [Русский](2026-05-20-backend-enhancement-plan.ru.md) · [Deutsch](2026-05-20-backend-enhancement-plan.de.md) · [Français](2026-05-20-backend-enhancement-plan.fr.md) · **Español** · [Português](2026-05-20-backend-enhancement-plan.pt.md) · [हिन्दी](2026-05-20-backend-enhancement-plan.hi.md) · [العربية](2026-05-20-backend-enhancement-plan.ar.md) · [বাংলা](2026-05-20-backend-enhancement-plan.bn.md) · [Bahasa Indonesia](2026-05-20-backend-enhancement-plan.id.md) · [日本語](2026-05-20-backend-enhancement-plan.ja.md)


> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Objetivo:** Implementar 13 mejoras de backend: 3 nuevos middlewares (CORS, RateLimit, OperationLog), 6 nuevos controladores, 2 modificaciones de modelos, configuración de rutas + middlewares.

**Arquitectura:** Seguir los patrones existentes de webman — los middlewares implementan `MiddlewareInterface::process()`, los controladores heredan de `BaseController`, las rutas se definen con closures o `[class, method]`. Los middlewares globales se registran en `config/middleware.php`, los middlewares a nivel de ruta se montan en los grupos de rutas de `config/route.php`.

**Stack tecnológico:** PHP 8.3+, webman v2, Redis (extensión), PhpSpreadsheet (importación)

**Orden de dependencias:** Modificaciones de modelos → middlewares → controladores → rutas/configuración

---

### Tarea 1: Añadir SoftDeletes + trait Searchable al modelo AdminUser

**Archivos:**
- Modificar: `app/model/AdminUser.php`

- [ ] **Paso 1: Modificar el modelo AdminUser**

Insertar dos importaciones `use` después de la línea 10 de `app/model/AdminUser.php` y usar ambos traits al inicio del cuerpo de la clase:
...
También añadir el método `toSearchableArray()` al final de la clase (después del método `roles()`, antes de la llave de cierre de la clase):
...
### Tarea 2: Middleware CORS

**Archivos:**
- Crear: `app/middleware/Cors.php`

- [ ] **Paso 1: Crear el middleware Cors**
...
### Tarea 3: Middleware de límite de velocidad RateLimit

**Archivos:**
- Crear: `app/middleware/RateLimit.php`

- [ ] **Paso 1: Crear el middleware RateLimit**
...
### Tarea 4: Middleware de registro de operaciones OperationLog

**Archivos:**
- Crear: `app/middleware/OperationLog.php`

- [ ] **Paso 1: Crear el middleware OperationLog**
...
### Tarea 5: Configuración de middlewares globales

**Archivos:**
- Modificar: `config/middleware.php`

- [ ] **Paso 1: Registrar los middlewares globales**

Cambiar el contenido de `config/middleware.php` a:
...
### Tarea 6: Controlador de verificación de salud

**Archivos:**
- Crear: `app/admin/controller/HealthController.php`

- [ ] **Paso 1: Crear HealthController**
...
### Tarea 7: Controlador CRUD de configuración del sistema

**Archivos:**
- Crear: `app/admin/controller/ConfigController.php`

- [ ] **Paso 1: Crear ConfigController**
...
### Tarea 8: Controlador de consulta de registros de operación

**Archivos:**
- Crear: `app/admin/controller/LogController.php`

- [ ] **Paso 1: Crear LogController**
...
### Tarea 9: Controlador de perfil personal (incluye cierre de sesión)

**Archivos:**
- Crear: `app/admin/controller/ProfileController.php`
- Modificar: `app/middleware/AdminAuth.php` (verificación de lista negra JWT)

- [ ] **Paso 1: Modificar el middleware AdminAuth para añadir verificación de lista negra JWT**

En el método `AdminAuth::process()`, insertar la comprobación de lista negra después de extraer el token y antes de decodificar el JWT:
...
También es necesario añadir la importación de Redis. Modificar el encabezado del archivo:
...
- [ ] **Paso 2: Crear ProfileController**
...
### Tarea 10: Controlador de carga de archivos

**Archivos:**
- Crear: `app/admin/controller/UploadController.php`

- [ ] **Paso 1: Crear UploadController**
...
### Tarea 11: Operaciones masivas de usuarios

**Archivos:**
- Modificar: `app/admin/controller/UserController.php`

- [ ] **Paso 1: Añadir dos métodos al final de la clase UserController (después del método `destroy`)**
...
### Tarea 12: Controlador de importación Excel

**Archivos:**
- Crear: `app/admin/controller/ImportController.php`

- [ ] **Paso 1: Crear ImportController**
...
### Tarea 13: Actualización de rutas — todas las rutas nuevas + enlace de middlewares

**Archivos:**
- Modificar: `config/route.php`

- [ ] **Paso 1: Actualizar la configuración de rutas**

Añadir las nuevas rutas dentro del grupo de rutas `/admin` y adjuntar el middleware OperationLog. Archivo de rutas completo:
...
Tras completar la implementación, verificar punto por punto:
