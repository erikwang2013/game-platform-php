...
डेटा विश्लेषण इंटरफ़ेस `AnalyticsController` द्वारा प्रदान किए जाते हैं, सभी MySQL रीयल-टाइम एग्रीगेशन पर आधारित (`erik_game_play_log` गेम व्यवहार लॉग / `erik_deposit_order` टॉप-अप ऑर्डर), डेटाबेस विफलता पर 500 के बजाय खाली डेटा लौटता है। विशेष उल्लेख के अलावा सभी के लिए JWT + RBAC प्रमाणीकरण आवश्यक है, प्रतिक्रिया प्रारूप समान है: `{ "code": 0, "message": "success", "data": ... }`।
