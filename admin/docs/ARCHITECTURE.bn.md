...
> নিচের Mermaid চার্টগুলো GitHub / GitLab / VS Code-এ স্বয়ংক্রিয়ভাবে রেন্ডার হয়। অন্যান্য পরিবেশে দেখতে [Mermaid Live Editor](https://mermaid.live/) ব্যবহার করুন।
...
## 12. নিরাপত্তা ডিফেন্স-ইন-ডেপথ প্যানোরামা
