...
ডেটা অ্যানালাইসিস ইন্টারফেস `AnalyticsController` প্রদান করে, সবগুলো MySQL রিয়েল-টাইম অ্যাগ্রিগেশন ভিত্তিক (`erik_game_play_log` গেম আচরণ লগ / `erik_deposit_order` টপ-আপ অর্ডার), ডেটাবেস ব্যর্থ হলে 500 নয় বরং খালি ডেটা ফেরত আসে। বিশেষ উল্লেখ ছাড়া সবগুলিতে JWT + RBAC অথেনটিকেশন প্রয়োজন, রেসপন্স র্যাপার ফরম্যাট একীভূত `{ "code": 0, "message": "success", "data": ... }`।
