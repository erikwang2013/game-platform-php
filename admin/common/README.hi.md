...
`common\service\*` साझा पैकेज **erik/platform-common** में रहता है:

`packages/platform-common`

इस निर्देशिका में PHP क्लासें न रखें (वे पैकेज के ऑटोलोड को छायांकित करेंगी)। देखें `packages/platform-common/README.hi.md`।
