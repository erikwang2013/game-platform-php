...
تعيش `common\service\*` في الحزمة المشتركة **erik/platform-common**:

`packages/platform-common`

لا تضع فئات PHP في هذا الدليل (ستظلل تحميل الحزمة التلقائي). راجع `packages/platform-common/README.ar.md`.
