...
`common\service\*` размещается в общем пакете **erik/platform-common**:

`packages/platform-common`

Не размещайте PHP-классы в этом каталоге (они будут перекрывать автозагрузку пакета). См. `packages/platform-common/README.ru.md`.
