...
`common\service\*` berada di paket bersama **erik/platform-common**:

`packages/platform-common`

Jangan letakkan kelas PHP di direktori ini (akan menutupi autoload paket). Lihat `packages/platform-common/README.id.md`.
