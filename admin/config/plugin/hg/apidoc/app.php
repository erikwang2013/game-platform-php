...
return [
    ...
    'apidoc' => [
        ...
        'desc' => '游戏管理、提现审核、用户管理、支付管理、KYC审核、公告、统计、导出、系统配置',
        'apps' => [[
            'title' => '管理后台 v1',
        ...
        'auto_url' => ['letter_rule' => "lcfirst", 'prefix' => "/admin"],
        ...
        'responses_status' => [
            ['name' => '200', 'desc' => '请求成功'], ['name' => '400', 'desc' => '参数错误'],
            ['name' => '401', 'desc' => '未认证'], ['name' => '403', 'desc' => '无权限'],
            ['name' => '404', 'desc' => '不存在'], ['name' => '422', 'desc' => '验证失败'],
            ['name' => '500', 'desc' => '服务端错误'],
        ],
        'default_author' => 'erik',
        'default_method' => 'GET',
