...
初めての Flutter プロジェクトの場合、参考になるリソースをいくつか紹介します：
...
Flutter 開発の開始にあたっては、チュートリアル、サンプル、モバイル開発のガイダンス、完全な API リファレンスを提供する[オンラインドキュメント](https://docs.flutter.dev/)を参照してください。
