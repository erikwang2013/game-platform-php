...
هذا المشروع نقطة انطلاق لتطبيق Flutter.
...
[الوثائق عبر الإنترنت](https://docs.flutter.dev/)، التي توفر دروسًا تعليمية،
وأمثلة، وإرشادات لتطوير تطبيقات الهاتف المحمول، ومرجع API كامل.
