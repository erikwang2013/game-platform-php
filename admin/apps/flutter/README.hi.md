...
एक नया Flutter प्रोजेक्ट।

## आरंभ करना

यह प्रोजेक्ट Flutter एप्लिकेशन का प्रारंभिक बिंदु है।

यदि यह आपका पहला Flutter प्रोजेक्ट है, तो शुरू करने के लिए कुछ संसाधन:

- [Flutter सीखें](https://docs.flutter.dev/get-started/learn-flutter)
- [अपना पहला Flutter ऐप लिखें](https://docs.flutter.dev/get-started/codelab)
- [Flutter सीखने के संसाधन](https://docs.flutter.dev/reference/learning-resources)

Flutter विकास शुरू करने में सहायता के लिए [ऑनलाइन दस्तावेज़ीकरण](https://docs.flutter.dev/) देखें, जिसमें ट्यूटोरियल, नमूने, मोबाइल विकास मार्गदर्शन और पूर्ण API संदर्भ उपलब्ध है।
