...
첫 Flutter 프로젝트라면 도움이 될 만한 리소스 몇 가지:

- [Flutter 배우기](https://docs.flutter.dev/get-started/learn-flutter)
- [첫 Flutter 앱 작성하기](https://docs.flutter.dev/get-started/codelab)
- [Flutter 학습 리소스](https://docs.flutter.dev/reference/learning-resources)

Flutter 개발 시작에 도움이 필요하면
[온라인 문서](https://docs.flutter.dev/)를 확인하세요. 튜토리얼,
샘플, 모바일 개발 가이드와 전체 API 레퍼런스를 제공합니다.
