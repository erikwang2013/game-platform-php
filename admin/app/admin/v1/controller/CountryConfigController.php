...
class CountryConfigController extends BaseController
{
    ...
    #[Apidoc\Method("POST")]
    #[Apidoc\Author("erik")]
    #[Apidoc\Param(name: "country_code", type: "string", require: true, desc: "国家代码(ISO 3166-1 alpha-2)")]
    #[Apidoc\Param(name: "currency", type: "string", require: true, desc: "货币代码(ISO 4217)")]
    #[Apidoc\Param(name: "payment_methods", type: "string", require: false, desc: "支付方式JSON数组")]
    #[Apidoc\Param(name: "withdraw_methods", type: "string", require: false, desc: "提现方式JSON数组")]
    #[Apidoc\Param(name: "min_deposit", type: "float", require: false, desc: "最低充值金额")]
    #[Apidoc\Returned(name: "id", type: "string", desc: "配置ID(hashid编码)")]
