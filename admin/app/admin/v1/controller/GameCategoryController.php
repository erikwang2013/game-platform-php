...
class GameCategoryController extends BaseController
{
    ...
    #[Apidoc\Method("GET")]
    #[Apidoc\Author("erik")]
    #[Apidoc\Returned(name: "id", type: "string", desc: "分类ID(hashid编码)")]
    ...
    #[Apidoc\Method("POST")]
    #[Apidoc\Author("erik")]
    #[Apidoc\Param(name: "name", type: "string", require: true, desc: "分类名称")]
    #[Apidoc\Param(name: "slug", type: "string", require: true, desc: "分类标识")]
    #[Apidoc\Param(name: "icon", type: "string", require: false, desc: "分类图标")]
    ...
    #[Apidoc\Method("POST")]
    #[Apidoc\Author("erik")]
    #[Apidoc\Param(name: "category_id", type: "string", require: true, desc: "分类ID(hashid编码)")]
    #[Apidoc\Param(name: "game_ids", type: "array", require: true, desc: "游戏ID数组(hashid编码)")]
