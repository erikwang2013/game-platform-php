...
{
    #[Apidoc\Title("工单列表")]
    #[Apidoc\Url("/admin/v1/ticket/list")]
    #[Apidoc\Method("GET")]
    ...
    #[Apidoc\Title("工单详情")]
    #[Apidoc\Url("/admin/v1/ticket/{hashid}")]
    #[Apidoc\Method("GET")]
    ...
    #[Apidoc\Title("回复工单")]
    #[Apidoc\Url("/admin/v1/ticket/{hashid}/reply")]
    #[Apidoc\Method("POST")]
    ...
    #[Apidoc\Title("关闭工单")]
    #[Apidoc\Url("/admin/v1/ticket/{hashid}/close")]
    #[Apidoc\Method("POST")]
    ...
    #[Apidoc\Title("指定处理人")]
    #[Apidoc\Url("/admin/v1/ticket/{hashid}/assign")]
    #[Apidoc\Method("POST")]
