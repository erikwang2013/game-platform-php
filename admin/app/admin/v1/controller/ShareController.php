...
class ShareController extends BaseController
{
    ...
    #[Apidoc\Method("GET")]
    #[Apidoc\Param(name: "activity_id", type: "string", require: false, desc: "活动ID(hashid)")]
    #[Apidoc\Param(name: "from", type: "string", require: false, desc: "起始日期 Y-m-d")]
    #[Apidoc\Param(name: "to", type: "string", require: false, desc: "结束日期 Y-m-d")]
