...
class CdnProviderController extends BaseController
{
    ...
    #[Apidoc\Method("GET")]
    #[Apidoc\Author("erik")]
    #[Apidoc\Returned(name: "id", type: "string", desc: "厂商ID(hashid编码)")]
    ...
    #[Apidoc\Method("POST")]
    #[Apidoc\Author("erik")]
    #[Apidoc\Param(name: "id", type: "string", require: true, desc: "厂商ID(hashid编码)")]
    ...
    #[Apidoc\Method("POST")]
    #[Apidoc\Author("erik")]
    #[Apidoc\Param(name: "name", type: "string", require: true, desc: "显示名称")]
    #[Apidoc\Param(name: "provider", type: "string", require: true, desc: "厂商(cloudflare/cloudfront/aliyun/tencent/huawei)")]
    #[Apidoc\Param(name: "config", type: "string", require: false, desc: "配置JSON(加密存储)")]
    #[Apidoc\Param(name: "status", type: "int", require: true, desc: "状态(0禁用,1启用)")]
