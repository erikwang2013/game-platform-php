...
class CouponController extends BaseController
{
    ...
    #[Apidoc\Method("GET")]
    #[Apidoc\Author("erik")]
    #[Apidoc\Returned(name: "id", type: "string", desc: "优惠券ID(hashid编码)")]
    ...
    #[Apidoc\Method("POST")]
    #[Apidoc\Author("erik")]
    #[Apidoc\Param(name: "name", type: "string", require: true, desc: "优惠券名称")]
    #[Apidoc\Param(name: "type", type: "string", require: true, desc: "优惠券类型(fixed固定金额,rate折扣率)")]
    #[Apidoc\Param(name: "value", type: "float", require: true, desc: "优惠券面值/折扣率")]
    #[Apidoc\Param(name: "min_amount", type: "float", require: false, desc: "最低消费金额")]
    #[Apidoc\Param(name: "max_discount", type: "float", require: false, desc: "最高折扣金额(rate类型有效)")]
    #[Apidoc\Param(name: "game_id", type: "string", require: false, desc: "适用游戏ID(hashid编码)")]
    #[Apidoc\Param(name: "total_qty", type: "int", require: false, desc: "总发放数量")]
    #[Apidoc\Param(name: "user_limit", type: "int", require: false, desc: "每人限领数量")]
    #[Apidoc\Returned(name: "id", type: "string", desc: "优惠券ID(hashid编码)")]
