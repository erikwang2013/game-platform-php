...
class UserController extends BaseController
{
     ...
     * @Apidoc\Method("GET")
     * @Apidoc\Param(name="hashid", type="string", require=true, desc="用户哈希ID")
     */
     ...
     * @Apidoc\Param(name="status", type="int", require=false, desc="状态: 0=禁用, 1=启用")
     * @Apidoc\Param(name="password", type="string", require=false, desc="新密码")
     * @Apidoc\Param(name="phone", type="string", require=false, desc="手机号")
     * @Apidoc\Param(name="email", type="string", require=false, desc="邮箱")
     */
     ...
     * @Apidoc\Method("POST")
     * @Apidoc\Param(name="ids", type="array", require=true, desc="用户哈希ID数组")
     * @Apidoc\Param(name="password", type="string", require=true, desc="管理员密码确认")
     */
