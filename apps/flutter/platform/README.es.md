...
# Especificar la dirección del backend (por defecto http://localhost:8792)
...
1. Inicia primero el backend: `cd service && php start.php start -d` (puerto por defecto 8792)
