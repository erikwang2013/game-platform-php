...
- ClickHouse (OLAP Analytics / Probability)
...
- `erikwang2013/clickhouse-php` — ClickHouse connection & probability
...
│   └── service/               #   Shared services (6, incl. ClickHouse dual-write+dashboard+probability)
│
├── apps/
...
| [Live Docs](http://localhost:8787/apidoc/) | Admin hg/apidoc interactive docs |
| [Live Docs](http://localhost:8788/apidoc/) | Service hg/apidoc interactive docs |
