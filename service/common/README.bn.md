...
`common\service\*` শেয়ার্ড প্যাকেজ **erik/platform-common**-এ থাকে:

`packages/platform-common`

এই ডিরেক্টরিতে PHP ক্লাস রাখবেন না (তারা প্যাকেজের autoload-কে ছায়া ফেলবে)। দেখুন `packages/platform-common/README.md`।
