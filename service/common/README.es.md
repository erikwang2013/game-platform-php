...
`common\service\*` vive en el paquete compartido **erik/platform-common**:

`packages/platform-common`

No pongas clases PHP en este directorio (harían sombra al autoload del paquete). Ver `packages/platform-common/README.md`.
