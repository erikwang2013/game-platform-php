...
`common\service\*` vive no pacote compartilhado **erik/platform-common**:

`packages/platform-common`

Não coloque classes PHP neste diretório (elas fariam sombra ao autoload do pacote). Ver `packages/platform-common/README.md`.
