...
| Länderspezifische Konfiguration | - | - | ✓ 18 Länder |
...
| Gesundheitscheck | ✓ | ✓ | ✓ |
| erikwang2013/apidoc-php-Online-Dokumentation | - | - | ✓ 80 Controller |
...
### Neu in Ökosystem v2.0 (14 Tabellen)
```
...
| Private Nachrichten/Chat | REST + WebSocket-Echtzeitnachrichten (Port 8791) |
