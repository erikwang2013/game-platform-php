...
- ডেটা রিপোর্ট: অ্যাডমিন `/admin/report/summary|daily|export` (সারাংশ/দৈনিক/CSV এক্সপোর্ট, Redis ৫ মিনিট ক্যাশ, সময়সীমা ≤৯০ দিন)।
- প্ল্যাটফর্ম পরিসংখ্যান (C-সাইড): `GET /api/platform/stats` (মোট গেম/ব্যবহারকারী/আজকের প্লে/৭ দিন সক্রিয়), হোম পরিসংখ্যানে সংযুক্ত।
- অ্যাডমিন Flutter: ড্যাশবোর্ড স্ট্যাট কার্ড বাস্তব ডেটায় সংযুক্ত, নতুন রিপোর্ট পেজ ReportsPage (/reports)।
- ডক সিঙ্ক: FEATURES/VERSIONS/API-তে রিপোর্ট ও পরিসংখ্যান এন্ট্রি ১৩ ভাষায় যোগ, ফিচার ডায়াগ্রামের পরিসংখ্যান বক্স আপডেট।
