...
- تقارير البيانات: لوحة الإدارة `/admin/report/summary|daily|export` (ملخص/يومي/تصدير CSV، كاش Redis 5 دقائق، فترة ≤90 يومًا).
- إحصائيات المنصة (الجانب C): `GET /api/platform/stats` (إجمالي الألعاب/المستخدمين/جولات اليوم/نشطون 7 أيام)، مربوطة بعرض الصفحة الرئيسية.
- Flutter الإدارة: بطاقات إحصائيات لوحة المعلومات مربوطة بالبيانات الفعلية، صفحة تقارير جديدة ReportsPage (/reports).
- مزامنة الوثائق: إضافة إدخالات التقارير والإحصائيات في FEATURES/VERSIONS/API بـ13 لغة، تحديث صندوق التحليل الإحصائي في مخطط الوظائف.
