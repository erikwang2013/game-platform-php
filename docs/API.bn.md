...
- C-এন্ড ব্যবসা: http://localhost:8792/apidoc/
- অ্যাডমিন প্যানেল: http://localhost:8789/apidoc/
- পাসওয়ার্ড: ডিপ্লয় পরিবেশের `APIDOC_PASSWORD` কনফিগ দেখুন
...
| এন্ড | ঠিকানা |
|----|------|
| অ্যাডমিন প্যানেল | `http://localhost:8789` |
| C-এন্ড ব্যবসা | `http://localhost:8792` |
...
## 2. C-এন্ড ইন্টারফেস (service :8792)
...
## 3. অ্যাডমিন প্যানেল ইন্টারফেস (admin :8789)
...
### 10.1 ঝুঁকি ব্যবস্থাপনা (অ্যাডমিন :8789)
...
### 10.4 গ্রুপ / শেয়ার (ক্লায়েন্ট :8792 + অ্যাডমিন :8789)
