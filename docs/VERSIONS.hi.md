...
| डेटा रिपोर्ट (सारांश/दैनिक/CSV) | - | - | ✓ |
| प्लेटफ़ॉर्म सांख्यिकी (C-साइड) | - | - | ✓ |
...
| देश-विभेदित कॉन्फ़िगरेशन | - | - | ✓ 18 देश |
...
| CDN | - | - | ✓ 5 विक्रेताओं का एकीकरण + एडमिन कॉन्फ़िग/सक्षम-अक्षम/कनेक्टिविटी टेस्ट (क्रेडेंशियल एन्क्रिप्टेड, service केवल DB से पढ़ता है) |
| Crontab निर्धारित कार्य | - | ✓ | ✓ |
| Prometheus निगरानी | ✓ | ✓ | ✓ `/metrics` व्यावसायिक gauge + इवेंट counter |
| स्वास्थ्य जाँच | ✓ | ✓ | ✓ |
| erikwang2013/apidoc-php ऑनलाइन दस्तावेज़ | - | - | ✓ 80 कंट्रोलर |
...
### इकोसिस्टम v2.0 में नई (14 तालिकाएँ)
```
...
| निजी संदेश/चैट | REST + WebSocket रीयल-टाइम संदेश (पोर्ट 8791) |
