...
Event: `['table' => '表名', 'alias' => '关联字段', 'where' => [...], 'whereRaw' => '...']`
...
Already wired into `GameController::launch()`.
...
Already wired into `DepositController::create()` and `PaymentController::callback()`.
