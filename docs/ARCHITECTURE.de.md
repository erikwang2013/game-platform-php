...
### 2.2 service/ — C-End-Geschäftsbackend
...
### 2.3 Provider-Schicht — Abstraktion der Spielanbindung
...
### service/ (C-End-Geschäftsbackend)
...
### 4.4 Game-Provider-Interaktionsfluss
...
|------|------|------|
| admin/ | 8787 | Verwaltungsbackend-API |
| service/ | 8788 | C-End-Geschäfts-API |
| leaderboard-ws | 8789 | WebSocket-Echtzeit-Rangliste |
| chat-ws | 8791 | WebSocket-Direktnachrichten/Chat |
| MySQL | 3306 | Hauptdatenbank |
| Redis | 6379 | Cache/Ratenbegrenzung/WebSocket/EventBus |
| ClickHouse | 8123 | OLAP-HTTP-Schnittstelle |
| Elasticsearch | 9200 | Volltextsuche |
...
|------|------|--------|------|
| Verwaltungsbackend | :8787/apidoc/ | 28 | ~85 |
| C-End-Geschäft | :8788/apidoc/ | 25 | ~65 |
...
Basierend auf dem `feature.*`-Namensraum in `erik_platform_config`, ohne zusätzliche Abhängigkeiten:

| Schalter | Standard | Funktion |
|------|------|------|
| feature.tournament | off | Turniersystem |
| feature.chat | off | WebSocket-Direktnachrichten |
| feature.vip | off | VIP-Treueprogramm |
| feature.achievements | off | Errungenschafts-Abzeichen |
