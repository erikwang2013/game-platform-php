...
ইতোমধ্যে বাস্তবায়িত ক্ষমতা: JWT+RBAC, ওয়ালেট অপটিমিস্টিক লক, টপ-আপ(Stripe/PayPal/NowPayments/Coinbase ভেরিফিকেশন), বিনিময় স্প্রেড, উত্তোলন রিভিউ+PayPal পেমেন্ট, গেম CRUD/Provider গেটওয়ে(HMAC), কুপন/VIP/অ্যাচিভমেন্ট/টিকিট/রেফারেল কমিশন/2FA/সোশ্যাল(ফ্রেন্ড/চ্যাট WS)/টুর্নামেন্ট/Webhook/পুশ(FCM/APNs/হুয়াওয়ে)/i18n দ্বিভাষিক।
