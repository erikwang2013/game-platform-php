...
| Рейтинги | WebSocket-пуш в реальном времени (порт 8790) | выполнено |
...
| Личные сообщения/чат | REST-сообщения + WebSocket в реальном времени (порт 8791), только друзья | выполнено |
