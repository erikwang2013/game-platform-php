...
| Пополнение | создание ордера на пополнение (Stripe 125+ локальных платежей / NOWPayments USDT TRC20·ERC20 / Coinbase USDC·BTC·ETH / callback PayPal) | выполнено |
...
| Платежи | автоматические колбэки нескольких платёжных каналов (Stripe/PayPal/NOWPayments IPN/Coinbase Webhook) | выполнено |
...
| Платежи | проверка подписи колбэков (Webhook Stripe/PayPal, NOWPayments IPN HMAC-SHA512, Coinbase HMAC-SHA256 secret base64) | выполнено |
