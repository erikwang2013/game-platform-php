...
| Пополнение | создание ордера на пополнение (единый платёж) | выполнено |
...
| Платежи | автоматические колбэки нескольких платёжных каналов (Stripe/PayPal) | выполнено |
...
| Платежи | проверка подписи Webhook Stripe/PayPal | выполнено |
