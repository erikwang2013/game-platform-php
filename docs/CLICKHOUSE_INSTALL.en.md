...
Verify: `clickhouse-client -q "SELECT version()"` or `curl 'http://localhost:8123/?query=SELECT+1'`
...
`composer.json` already includes `erikwang2013/clickhouse-php: ^1.0`, configured in `config/plugin/erikwang2013/clickhouse-php/app.php`.
