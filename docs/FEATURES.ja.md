...
| VIP 体系 | 5段階 (ノーマル/シルバー/ゴールド/プラチナ/ダイヤモンド) + 経験値 + 自動昇格 | 完了 |
| VIP 特典 | 交換割引 2-15%、出金手数料免除 10-100%、レートボーナス 0.1-1.0% | 完了 |
...
| ランク | 累計EXP | 交換割引 | 出金手数料免除 | レートボーナス |
|------|---------|---------|-------------|---------|
| ノーマル | 0 | 0% | 0% | 基準 |
| シルバー | 500 | 2% | 10% | +0.1% |
| ゴールド | 2,500 | 5% | 30% | +0.3% |
| プラチナ | 12,500 | 10% | 50% | +0.5% |
| ダイヤモンド | 62,500 | 15% | 100% | +1.0% |
