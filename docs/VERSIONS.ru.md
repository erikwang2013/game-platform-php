...
| Отчёты по данным (сводный/ежедневный/CSV) | - | - | ✓ |
| Статистика платформы (C-сторона) | - | - | ✓ |
...
| CDN | - | - | ✓ Интеграция 5 вендоров + настройка/вкл-выкл/тест подключения в админке (учётные данные зашифрованы, service читает только из БД) |
| Планировщик Crontab | - | ✓ | ✓ |
