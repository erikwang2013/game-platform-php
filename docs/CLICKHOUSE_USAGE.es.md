...
Evento: `['table' => '表名', 'alias' => '关联字段', 'where' => [...], 'whereRaw' => '...']`
...
Ya conectado en `GameController::launch()`.
...
Ya conectado en `DepositController::create()` y `PaymentController::callback()`.
...
## 6. API del dashboard del backend
