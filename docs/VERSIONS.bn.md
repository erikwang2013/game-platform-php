...
| ডেটা রিপোর্ট (সারাংশ/দৈনিক/CSV) | - | - | ✓ |
| প্ল্যাটফর্ম পরিসংখ্যান (C-সাইড) | - | - | ✓ |
...
| CDN | - | - | ✓ ৫টি ভেন্ডর ইন্টিগ্রেশন + অ্যাডমিন কনফিগ/সক্রিয়-নিষ্ক্রিয়/সংযোগ পরীক্ষা (ক্রেডেনশিয়াল এনক্রিপ্ট করা, service শুধুমাত্র DB থেকে পড়ে) |
