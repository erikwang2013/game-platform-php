...
Verifikasi: `clickhouse-client -q "SELECT version()"` atau `curl 'http://localhost:8123/?query=SELECT+1'`
...
`composer.json` sudah menyertakan `erikwang2013/clickhouse-php: ^1.0`, konfigurasi berada di `config/plugin/erikwang2013/clickhouse-php/app.php`.
