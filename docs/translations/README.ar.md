...
| v1.3.15-22 (8 إصدارات) | المطابقة/التسوية، تعميق مراقبة المخاطر، محفظة موحدة، محرك الأنشطة، مكافحة الغش، النمو الاجتماعي، Adyen/GrabPay | مكتمل |
...
| تعميق مراقبة المخاطر | بصمة الجهاز / سمعة عنوان IP / رسم بياني لربط الحسابات + محرك القواعد + لوحة مخاطر + AML/KYC/درجة الثقة |
| مكافحة الغش | جمع أحداث مكافحة الغش + إحصائيات يومية + مراجعة يدوية |
| المطابقة/التسوية | دفعات مطابقة يومية + تفاصيل الفروق + مطابقة البيانات |
| محفظة موحدة | WalletScope نطاق المحفظة الموحدة |
| محرك الأنشطة | إنشاء/مشاركة/مكافآت الأنشطة + تسجيل الحضور |
