...
|------|------|--------|------|
| Panel de administración | :8789/apidoc/ | 28 | ~85 |
| Negocio del lado C | :8792/apidoc/ | 25 | ~65 |
...
Basado en el namespace `feature.*` de `game-platform_config`, sin dependencias adicionales:
