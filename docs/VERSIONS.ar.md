...
| كشف اللغة تلقائيًا | ✓ | ✓ | ✓ |
| إعدادات تفاضلية حسب الدولة | - | - | ✓ 18 دولة |
...
| فحص الصحة | ✓ | ✓ | ✓ |
| توثيق erikwang2013/apidoc-php عبر الإنترنت | - | - | ✓ 80 وحدة تحكم |
...
### إضافات النظام البيئي v2.0 (14 جدولًا)
```
...
| الرسائل الخاصة/المحادثة | REST + WebSocket رسائل لحظية (المنفذ 8791) |
