...
```
Panel de administración (7):  erik_admin_user, erik_admin_role, erik_admin_permission,
               erik_admin_user_role, erik_admin_role_permission,
               erik_operation_log, erik_system_config

Núcleo de la plataforma (12): erik_user, erik_user_wallet, erik_user_game_wallet,
